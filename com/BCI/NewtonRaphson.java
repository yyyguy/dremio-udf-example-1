...
public class NewtonRaphson {
    ...
    /*
     * Construct an instance of the NewtonRaphson method for masochists who do not want to use {@link #builder()}.
     ...
     * @return an input to the function which yields zero within the given tolerance
     ...
     * <code>target</code>, starting at the <code>guess</code>.
     * More precisely, finds an input value <i>x</i> such that
     * |<i>f</i>(<i>x</i>) - <code>target</code>| &lt; <i>tolerance</i>
     * @param target the target value of the function
     * @param guess value to start the algorithm
     * @return the inverse of the function at <code>target</code> within the given tolerance
     * @throws com.BCI.ZeroValuedDerivativeException if the derivative is 0 while executing the Newton-Raphson method
     * @throws OverflowException when a value involved is infinite or NaN
     * @throws NonConvergenceException if the method fails to converge in the given number of iterations
     */
    ...
    public static class Builder {
        ...
        /*
         * Convenience method which builds the NewtonRaphson instance and invokes {@link NewtonRaphson#findRoot(double)}.
         *
