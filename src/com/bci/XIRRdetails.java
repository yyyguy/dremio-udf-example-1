...
/*
 * Converts a stream of {@link Transaction} instances into the data needed for the {@link XIRR} algorithm.
 */
class XIRRdetails {
    public static Collector<com.BCI.Transaction, XIRRdetails, XIRRdetails> collector() {
        return Collector.of(
                XIRRdetails::new,
    ...
    public void accumulate(final com.BCI.Transaction tx) {
